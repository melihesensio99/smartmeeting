...
export function App() {
  ...
  const { meetings, create, startRecording, upload, completeAction, updateAction, updateNotes, mapSpeaker, confirmSpeaker, rejectSpeaker, addParticipant, updateParticipantPermission, removeParticipant, leaveMeeting, sendEmail } = useMeetings()
