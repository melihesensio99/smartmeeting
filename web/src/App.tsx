...
export function App() {
  ...
  const { meetings, create, startRecording, upload, completeAction, updateAction, updateNotes, mapSpeaker, addParticipant, updateParticipantPermission, removeParticipant, leaveMeeting, sendEmail } = useMeetings()
