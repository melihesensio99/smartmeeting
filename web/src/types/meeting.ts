...
export const actionItemSchema = z.object({ id: z.string().uuid(), description: z.string(), assignee: z.string().nullable(), assigneeUserId: z.string().nullable(), assigneeUserIds: z.array(z.string()).default([]), dueAt: z.string().nullable(), priority: actionPrioritySchema, completed: z.boolean() })
