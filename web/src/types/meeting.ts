...
export const participantSchema = z.object({ id: z.string().uuid(), userId: z.string(), displayName: z.string(), email: z.string(), canManageMeeting: z.boolean(), speakerLabel: z.string().nullable() })
