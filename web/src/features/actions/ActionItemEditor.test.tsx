...
describe("ActionItemEditor", () => {
  it("manuel aksiyon açıklaması boşken kaydetmeyi engeller ve geçerli veriyi gönderir", () => {
    ...
    fireEvent.change(
      screen.getByRole("textbox", { name: "Görev / aksiyon açıklaması" }),
      { target: { value: "Yeni aksiyon" } },
    );
    fireEvent.change(screen.getByLabelText("Termin tarihi"), {
