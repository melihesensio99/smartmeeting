...
export function LoginPage() {
  const auth = useMutation({ mutationFn: (input: LoginInput) => login(input.email, input.password), onSuccess: (result) => { localStorage.setItem('smartmeeting-user', result.displayName); navigate('/') } })
