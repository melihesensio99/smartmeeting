...
public sealed class UploadMeetingAudioHandler(IApplicationDbContext db, IAudioStorage storage, IMeetingProcessingQueue queue) : IRequestHandler<UploadMeetingAudioCommand, Result<MeetingDto>>
{
